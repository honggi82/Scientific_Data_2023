...
% 'TF' is the time-frequency spectra of data. 
% 'TF' will be a matrix (time * frequency)
% 'data' should be a vector
% 'sf' is a sampling rate
% 'wnd_size' is the window size of the data
% 'baseline' is a period for baseline correction of analysis
% 'f_scale' is a frequency resolution of analysis
% 'freq_band' is a frequency band of analysis
% Set 'normal' to 1 if you want to normalize the spectrum values depending on the baseline
% 
